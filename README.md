...
This program is planning to support [DropBox](dropbox.com), [Catbox/Litterbox](catbox.moe), [Uguu/Pomf](uguu.se), and [Filebin](filebin.net). (currently this only supports catbox/litterbox and filebin but feel free to change that with a pr)
